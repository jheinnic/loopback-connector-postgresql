...
drop table if exists "reservation" cascade;
  ...
  create table "reservation"
   (	"id" varchar(64),
	...
	"pickup_date" date,
	"return_date" date,
	"loc_poly" geometry('polygon', 4326)
   ) ;
...
Insert into CUSTOMER (ID,USERNAME,EMAIL,PASSWORD,NAME,MILITARY_AGENCY,REALM,EMAILVERIFIED,VERIFICATIONTOKEN,CREDENTIALS,CHALLENGES,STATUS,CREATED,LASTUPDATED,HOME) values ('612','bat','bat@bar.com','$2a$10$BEG18wcYQn7TRkFIc59EB.vmnsEwqJWMlYM4DNG73iZb.MKA1rjAC',null,null,null,null,null,'[]','[]',null,null,null, 'SRID=4326;POINT(85 -40 1000)');
Insert into CUSTOMER (ID,USERNAME,EMAIL,PASSWORD,NAME,MILITARY_AGENCY,REALM,EMAILVERIFIED,VERIFICATIONTOKEN,CREDENTIALS,CHALLENGES,STATUS,CREATED,LASTUPDATED,HOME) values ('613','baz','baz@bar.com','$2a$10$jkSYF2gLMdI4CwVQh8AStOs0b24lDu9p8jccnmri/0rvhtwsicm9C',null,null,null,null,null,'[]','[]',null,null,null, 'SRID=4326;POINT(-20 -20 0)');
Insert into CUSTOMER (ID,USERNAME,EMAIL,PASSWORD,NAME,MILITARY_AGENCY,REALM,EMAILVERIFIED,VERIFICATIONTOKEN,CREDENTIALS,CHALLENGES,STATUS,CREATED,LASTUPDATED,HOME) values ('610','foo','foo@bar.com','$2a$10$tn1hN7Xv6x74cCB7tVfwkeaaJTd4/6q4RbCMzgmAJeWe40xqrRSui',null,null,null,null,null,'[]','[]',null,null,null,'SRID=4326;POINT(1 2 3)');
Insert into CUSTOMER (ID,USERNAME,EMAIL,PASSWORD,NAME,MILITARY_AGENCY,REALM,EMAILVERIFIED,VERIFICATIONTOKEN,CREDENTIALS,CHALLENGES,STATUS,CREATED,LASTUPDATED,HOME) values ('611','bar','bar@bar.com','$2a$10$a8mCol6d5vQXm6vubqXl8e5V66StEg6E8vzjQqPpoyk95Vm3smpiK',null,null,null,null,null,'[]','[]',null,null,null,null);
...
Insert into LOCATION (ID,STREET,CITY,ZIPCODE,NAME,GEO) values ('87','7153 East Thomas Road','Scottsdale','85251','Phoenix Equipment Rentals','-111.9271738,33.48034450000001','SRID=4326;POINT(-111.9271738 33.48034450000001)');
Insert into LOCATION (ID,STREET,CITY,ZIPCODE,NAME,GEO) values ('91','2799 Broadway','New York','10025','Cascabel Armory','-73.9676965,40.8029807','SRID=4326;POINT(-73.9676965 40.8029807)');
Insert into LOCATION (ID,STREET,CITY,ZIPCODE,NAME,GEO) values ('89','1850 El Camino Real','Menlo Park','94027','Military Weaponry','-122.194253,37.459525','SRID=4326;POINT(-122.194253 37.459525)');
Insert into LOCATION (ID,STREET,CITY,ZIPCODE,NAME,GEO) values ('92','32/66-70 Marine Parade','Coolangatta','4225','Marine Parade','153.536972,-28.167598','SRID=4326;POINT(153.536972 -28.167598)');
Insert into LOCATION (ID,STREET,CITY,ZIPCODE,NAME,GEO) values ('90','Tolstraat 200','Amsterdam','1074','Munitions Shopmore','4.907475499999999,52.3530638','SRID=4326;POINT(4.907475499999999 52.3530638)');
Insert into LOCATION (ID,STREET,CITY,ZIPCODE,NAME,GEO) values ('88','390 Lang Road','Burlingame','94010','Bay Area Firearms','-122.3381437,37.5874391','SRID=4326;POINT(-122.3381437 37.5874391)');
...
INSERT INTO reservation (id,product_id,location_id,qty,status,reserve_date,pickup_date,return_date,loc_poly) VALUES ('1','45','','610',4,'Ok','now()','now()','now()','SDRI=4326;POLYGON((0 0, 4 4, 8 2, 0 0))');
